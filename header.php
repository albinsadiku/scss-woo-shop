...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'teeflex' ); ?></a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<ul class="announcement-bar__list">
						<li>
							...
							<a href="tel: +44 555 22211" class="text-decoration-none">+38349433559</a>
						</li>

						<li>
							<i class="bi bi-envelope rounded-circle"></i>
							<a href="mailto:contact@teeflex.com" class="text-decoration-none">contact@teeflex.com</a>
						</li>
					</ul>
				...
				<div class="col-md-8 d-flex justify-content-end">
					<ul class="announcement-bar__list">
						<li>
							<i class="bi bi-truck"></i>FREE EU SHIPPING
						</li>
			...
			<div class="row">
				<div class="col-12 d-flex justify-content-center">
					<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
						...
						<?php esc_html_e( 'Primary Menu', 'teeflex' ); ?>
					</button>
				</div>
